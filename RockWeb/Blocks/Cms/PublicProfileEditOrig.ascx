<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PublicProfileEditOrig.ascx.cs" Inherits="RockWeb.Blocks.Cms.PublicProfileEditOrig" %>
    ...
    <ContentTemplate>
        ...
        <div class="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <%-- View Panel --%>
                <asp:Panel ID="pnlView" CssClass="panel-view" runat="server" BorderStyle="Solid" BorderColor="Magenta" BorderWidth="5">
                    <div class="row">
